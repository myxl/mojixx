...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  created: function created() {
    ...
    Object(_api_permissionGroup__WEBPACK_IMPORTED_MODULE_0__["getPermissionGroupList"])().then(function (response) {
...
var render = function() {
  ...
  return _c(
    "el-select",
    {
      attrs: { placeholder: _vm.$t("permissionGroup") },
      model: {
        value: _vm.optionValue,
        callback: function($$v) {
          _vm.optionValue = $$v
...
/*!*********************************************!*\
  !*** ./resources/js/api/permissionGroup.js ***!
  \*********************************************/
/*! exports provided: getPermissionGroupList, guardNameForPermissions, addPermissionGroup, editPermissionGroup, deletePermissionGroup */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
